        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Por favor, confirmes os dados abaixo para realizar a transferênica:</h3>
                </div>
                <div class="box-body">
                    ...
                    <form action="{{ route('store.transfer') }}" method="POST">
                        ...
                        <div class="form-group">
                            <label>Valor:</label>
                            <input type="text" name="vlTransferencia" class="form-control" placeholder="Digite o valor para a transferência..." />
                        </div>
